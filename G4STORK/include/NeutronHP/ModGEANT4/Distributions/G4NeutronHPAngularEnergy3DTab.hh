...
//
//
#ifndef G4NeutronHPAngularEnergy3DTab_h
#define G4NeutronHPAngularEnergy3DTab_h 1
...
class G4NeutronHPAngularEnergy3DTab : public G4VNeutronHPEnergyAngular
{
  public:

  G4NeutronHPAngularEnergy3DTab()
  {
    theEnergies = 0;
    theData = 0;
    nEOut = 0;
  ...
  //outgoing energy summed probability data
  G4double ** nEProbSum;
