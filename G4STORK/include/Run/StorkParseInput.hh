...
class StorkParseInput
{
	public:
		...
		G4bool GetNeutronHPModCheck() const { return neutronHPMod; }
        ...
        //Scoring
        G4String GetScoreIsoDir() const { return scoreIsoDir; }
        G4bool GetScoreIsoCheck() const { return scoreIsoCheck; }
		void SetScoreIsoDir(G4String scoreIsoDir);

        G4String GetScoreReacDir() const { return scoreReacDir; }
        G4bool GetScoreReacCheck() const { return scoreReacCheck; }
		void SetScoreReacDir(G4String scoreReacDir);

        G4String GetScoreIsoReacDir() const { return scoreIsoReacDir; }
        G4bool GetScoreIsoReacCheck() const { return scoreIsoReacCheck; }
		void SetScoreIsoReacDir(G4String scoreIsoReacDir);

        G4String GetScoreIsoEnerDir() const { return scoreIsoEnerDir; }
        G4bool GetScoreIsoEnerCheck() const { return scoreIsoEnerCheck; }
		void SetScoreIsoEnerDir(G4String scoreIsoEnerDir);
	...
	private:
        ...
        //Scoring
        G4String scoreIsoDir;
        G4String scoreReacDir;
        G4String scoreIsoReacDir;
        G4String scoreIsoEnerDir;

        G4bool scoreIsoCheck;
        G4bool scoreReacCheck;
        G4bool scoreIsoReacCheck;
        G4bool scoreIsoEnerCheck;
