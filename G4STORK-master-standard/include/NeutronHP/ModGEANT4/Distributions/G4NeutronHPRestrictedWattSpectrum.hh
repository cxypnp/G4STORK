...
//
//
#ifndef G4NeutronHPRestrictedWattSpectrum_h
#define G4NeutronHPRestrictedWattSpectrum_h 1
...
class G4NeutronHPRestrictedWattSpectrum : public G4VNeutronHPEDis
{
  public:
  G4NeutronHPRestrictedWattSpectrum()
  {
    expm1 = std::exp(-1.);
  }
  ~G4NeutronHPRestrictedWattSpectrum()
